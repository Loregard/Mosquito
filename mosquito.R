...
ibm_daphnia = new("indbasedModel",
                  ...
                  init = data.frame(age=0, fase=4, eggs=5, gdd=0, ovoposicao = 0),
...
myiteration = function(y, times = NULL, func = NULL, parms = NULL,
  ...
  observer = function(res) { 
    ...
    c(number=number, meanfase=meanfase, meanage=meanage)
  }
  init              = y@init
...
setMethod("plot", c("indbasedModel", "missing"), function(x, y, ...) {
  ...
  plot(o$times, media, type="l", xlab="Time", ylab="Eggs per individual")
